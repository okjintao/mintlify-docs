...
description: "How Berachain's governance works"
---
...
Governance proposals can be discussed and created on [BeraHub](https://hub.berachain.com/governance/general/). Creating a governance proposal requires adhering to the following:
