...
description: "How the Incentive Marketplace works in Berachain's Proof-of-Liquidity"
---
...
![Berachain Reward Vault Incentive Marketplace](/images/berachain-incentive-marketplace.png)
...
5. A user (Booster) wanting to claim their Incentive token rewards retrieves this proof and claims their incentive token rewards through the BGTIncentiveDistributor contract. All proof handling is done by interacting with [Berachain Hub](https://hub.berachain.com).
