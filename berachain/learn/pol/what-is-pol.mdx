...
description: What is Berachain's Proof-of-Liquidity & How Does it Work?
---
...
1. [`$BERA`](/berachain/learn/pol/tokens/bera) - Validators secure the chain by staking the native gas token
2. [`$BGT`](/berachain/learn/pol/tokens/bgt) - A soulbound governance token distributed by validators for proposing new blocks, which is ultimately rewarded to users who provide ecosystem liquidity (see [Reward Vaults](./rewardvaults))

A validator's `$BGT` emissions increase with the amount of `$BGT` delegated to them. Protocol-provided [Incentives](/berachain/learn/pol/incentives) are received for these emissions, and validators pass these to their delegators after collecting a commission.
...
> Read more in [Proof-of-Liquidity Overview](/berachain/learn/pol/overview)
