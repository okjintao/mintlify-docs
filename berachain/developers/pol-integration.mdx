---
title: Building with Proof-of-Liquidity
description: Learn how to integrate your dApp with Berachain's Proof-of-Liquidity system for incentivizing user activity
---
...
**When to use**: Institutional services, custody solutions, or complex delegation patterns. See the [advanced PoL guide](/berachain/developers/guides/advanced-pol) for details.
...
[Explore Merkle Manager →](https://playground.berachain.com/reward-vault-manager-merkle)
...
[Explore Loot Boxes →](https://playground.berachain.com/reward-vault-loot-boxes)
...
[Explore Real-Time Rewards →](https://playground.berachain.com/real-time-rewards)
