...
<AccordionGroup>
  ...
  <Accordion icon="rectangle-terminal" title="Start the preview server">
    1. Install the Berachain CLI: `npm i -g mint`
...
<AccordionGroup>
  <Accordion icon="github" title="Install our GitHub app">
    Install the Berachain GitHub app from your [dashboard](https://dashboard.mintlify.com/settings/organization/github-app).
