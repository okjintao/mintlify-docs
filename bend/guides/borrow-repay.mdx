...
![Berachain Bend - Borrow & Connect Wallet](/images/learn-guide-borrow-01.png)
...
![Berachain Bend - Choose Market](/images/learn-guide-borrow-02.png)
...
![Berachain Bend - Configure Borrow](/images/learn-guide-borrow-03.png)
...
![Berachain Bend - Approve & Supply](/images/learn-guide-borrow-04.png)

![Berachain Bend - Successful Approve & Supply](/images/learn-guide-borrow-05.png)

You should now see the successfully supplied collateral and total value in the market.

![Berachain Bend - Successful Supply](/images/learn-guide-borrow-06.png)
...
![Berachain Bend - Borrow](/images/learn-guide-borrow-07.png)

### 6. Approve & Borrow

Approve the borrow of $HONEY.

![Berachain Bend - Approve Borrow](/images/learn-guide-borrow-08.png)

![Berachain Bend - Successful Approve Borrow](/images/learn-guide-borrow-09.png)

You should now see the successfully borrowed $HONEY and its value reflected in the market.

![Berachain Bend - Successful Borrow](/images/learn-guide-borrow-10.png)

### 7. Avoid Liquidation

Monitor your position carefully to ensure it is not liquidated if your LTV exceeds the Liquidation Loan-To-Value (LLTV).

![Berachain Bend - Monitor LTV/LLTV](/images/learn-guide-borrow-12.png)
...
![Berachain Bend - Configure Repay](/images/learn-guide-repay-01.png)

### 2. Confirm Repay

Confirm the repayment transaction.

![Berachain Bend - Confirm Repay](/images/learn-guide-repay-02.png)

![Berachain Bend - Successful Confirm Repay](/images/learn-guide-repay-03.png)

You should now see the successful repayment showing a zero balance.

![Berachain Bend - Successful Repay](/images/learn-guide-repay-04.png)
